...
CameraComponent) {
    return class CameraWithTensorStream extends React.Component {
        ...
        async onGLContextCreate(gl) {
            ...
            const { resizeHeight, resizeWidth, resizeDepth, cameraTextureHeight, cameraTextureWidth, rotation, } = this.props;
            //
            ...
            function* nextFrameGenerator() {
                ...
                while (cameraStreamView.glContext != null) {
                    const imageTensor = fromTexture(gl, cameraTexture, textureDims, targetDims, { rotation });
                    yield imageTensor;
                }
            }
